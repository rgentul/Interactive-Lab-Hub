...
While our design is more of an extreme example, this distributed system could be applied to large line kitchens where chef's need to communicate with each other without actually interacting. Mass production lines in particular would benefit from these systems.
